...
namespace RequestTrackerCFBLLibrary
{
    public interface IAdminBL
    {
        ...
        public Task<IList<Request>> GetAllRequestsReceived(int empid);
        ...
        public Task<RequestSolution> ProvideSolution(int empid, int reqId, RequestSolution requestsolution);
